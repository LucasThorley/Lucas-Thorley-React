      ...
      <nav className="header-full-nav">
        <div className="header-full-container">
          ...
          <div className="header-full-menu">
            ...
            <Link to="/portfolio" className="header-full-navlink2 Large">
              Portfolio
            </Link>
            <Link to="/contact-me" className="header-full-navlink3 Large">
              Contact Me
            </Link>
          </div>
          <div className="header-full-container1">
            <div className="header-full-container2">
              <Link to="/contact-me" className="header-full-navlink4">
                <PrimaryPinkButton
                  button="Contact Me"
